...
# Nunca invente valores fora daqui. Se não estiver listado, responda: "Vou confirmar e retorno."
...
# Mapeamento simples para relacionar dúvidas/queixas com serviços
SERVICO_KEYWORDS = {
